...
///     potential entity).
///
/// This version uses iter-matcher instead of the `ENTITIES` map. It is faster
...
///     potential entity).
///
/// This version uses the [`ENTITIES`] map instead of iter-matcher. It is
/// slower at runtime but faster to build.
